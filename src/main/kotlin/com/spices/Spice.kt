...
abstract class Spice(val name: String, val spiciness: String = "mild", color: String):SpiceColor by color{
    abstract fun prepareSpice()
}
class Curry (name: String, spiciness: String, override var color: String):Spice( name, spiciness, color ="yellow color"  ),Grinder{
...
fun main(){
    var obj=Curry("curry","mild","yellow")
    println(obj.color)
